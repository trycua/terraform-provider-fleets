...
require 'rust_target: x86_64-pc-windows-gnullvm' "$workflow"
...
require "sha256sum ./*.zip \"terraform-provider-fleets_\${VERSION}_manifest.json\"" "$workflow"
...
require '-lwindows.*)' "$builder"
require "packaged_archive=\"lib\${library#-l}.a\"" "$builder"
